...
import fish.cichlidmc.tinycodecs.util.Functions.F1;
import fish.cichlidmc.tinycodecs.util.Functions.F2;
import fish.cichlidmc.tinycodecs.util.Functions.F3;
import fish.cichlidmc.tinycodecs.util.Functions.F4;
import fish.cichlidmc.tinycodecs.util.Functions.F5;
import fish.cichlidmc.tinycodecs.util.Functions.F6;
