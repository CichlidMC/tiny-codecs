...
/// Encodes a value to a [JsonObject].
/// @see Encoder
@FunctionalInterface
public interface MapEncoder<T> {
	/// Encode the given value onto the given [JsonObject].
	...
	/// In addition, if an error occurs, the given [JsonObject] should not be modified.
